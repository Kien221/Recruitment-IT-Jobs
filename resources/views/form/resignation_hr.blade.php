        ...
        <div class="row">
            <div class="col-md-6">
                <div class="main_form_signup">
                    ...
                    <form action="{{route('resignation.hr')}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form">
                            <div class="input">
                            ...
                            <div class="input">
                                ...
                                @if(session('email_exited'))
                                    <div class="text-danger text-left">
                                        {{session('email_exited')}}
                                    </div>
                                @endif
                            </div>
                            <div class="input">
                            ...
                            <div class="input">
                                ...
                                @if(session('fails_password'))
                                <div class="text-danger text-left">{{session('fails_password')}}</div>
                                @endif
                            </div>
                        </div>
