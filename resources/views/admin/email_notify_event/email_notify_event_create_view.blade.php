        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-xs-9">
                            ...
                            @endif
                    <h1>Tạo thông tin sự kiện</h1>
                    <form action="{{route('email_notify_event.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        ">
                            ...
                            <textarea name="content" id="editor" cols="30" rows="10" required>
                            </textarea>
                        </div>
                        <div class="form-group
                        ">
